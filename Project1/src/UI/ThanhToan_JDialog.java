 ...
 * @author admin
 */
public class ThanhToan_JDialog extends javax.swing.JDialog {

    /**
     * Creates new form ThanhToan_JDialog
     */
    public ThanhToan_JDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThanhToan_JDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThanhToan_JDialog dialog = new ThanhToan_JDialog(new javax.swing.JFrame(), true);
